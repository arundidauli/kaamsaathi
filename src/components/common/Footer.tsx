      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          ...
          <div className="space-y-2">
            <p className="text-slate-200 font-bold uppercase tracking-wider text-[11px]">Explore</p>
          ...
          <div className="space-y-2">
            <p className="text-slate-200 font-bold uppercase tracking-wider text-[11px]">Community</p>
            <ul className="space-y-2 text-slate-400">
              <li>
          ...
          <div className="space-y-2">
            <p className="text-slate-200 font-bold uppercase tracking-wider text-[11px]">Trust & Policy</p>
            <ul className="space-y-2 text-slate-400">
              <li>
              ...
              <li className="text-slate-500 pt-1">{APP_CONFIG.supportEmail}</li>
            </ul>
          </div>
        </div>
